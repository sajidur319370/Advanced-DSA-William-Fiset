...
public class HashTableOpenAddressingLinearProbing<K, V> implements Iterable<K> {
	...
	protected HashTableOpenAddressingLinearProbing() {
		this(DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR);
	}

	protected HashTableOpenAddressingLinearProbing(int capacity) {
		this(capacity, DEFAULT_LOAD_FACTOR);
	}

	// Designated constructor
	protected HashTableOpenAddressingLinearProbing(int capacity, double loadFactor) {
		if (capacity <= 0)
	...
	protected int probe(int x) {
		// Linear probing function (LINEAR_CONSTANT = a)*x
