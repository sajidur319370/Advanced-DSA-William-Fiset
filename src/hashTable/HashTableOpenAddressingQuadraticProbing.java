...
public class HashTableOpenAddressingQuadraticProbing<K, V> implements Iterable<K> {
	...
	protected HashTableOpenAddressingQuadraticProbing() {
		this(DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR);
	}

	protected HashTableOpenAddressingQuadraticProbing(int capacity) {
		this(capacity, DEFAULT_LOAD_FACTOR);
	}

	// Designated constructor
	protected HashTableOpenAddressingQuadraticProbing(int capacity, double loadFactor) {
		if (capacity <= 0)
	...
	// This is important to be able to override because the size of the hash table
